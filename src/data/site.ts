...
/**
 * The logbook is only worth reading if its dates are true, so every date here
 * is the repository's own: `started` is the day the repo was created, `updated`
 * the day it was last pushed. Entries are numbered in the order they were
 * opened, which is also the order they are read.
 */
export type Project = {
  number: string;
  title: LocalizedText;
  ...
  stack: string[];
  url: string;
  /** Entry number of the nearest neighbour in the log — a real relation, not a filler link. */
  cf: string;
};
...
export const site = {
  ...
  location: {
    en: 'Spain · remote or hybrid',
    es: 'España · remoto o híbrido',
  } as LocalizedText,
};
...
export const projects: Project[] = [
  {
    ...
    repo: 'eastron-lorawan-energy-monitoring',
    started: '2026-06-02',
    updated: '2026-09-06',
    cf: '12',
    terminal: {
      en: 'telemetry — sdm230 · live uplink',
      es: 'telemetría — sdm230 · uplink en vivo',
    },
    description: {
  ...
  },
  {
    ...
    cf: '11',
    terminal: {
      en: 'aegis — soc console · sse:connected',
      es: 'aegis — consola soc · sse:conectado',
    },
    description: {
  ...
  },
  {
    ...
    cf: '06',
    terminal: {
      en: '$ sudo pyscan scan 10.0.8.0/24 --top-ports 100',
      es: '$ sudo pyscan scan 10.0.8.0/24 --top-ports 100',
    },
    description: {
  ...
  },
  {
    ...
    cf: '05',
    terminal: {
      en: 'sentinel — room-1 · presence:yes · ml:on-device',
      es: 'sentinel — sala-1 · presencia:sí · ml:on-device',
    },
    description: {
  ...
  },
  {
    ...
    cf: '10',
    terminal: {
      en: 'agrisentinel — signed frame · replay rejected',
      es: 'agrisentinel — frame firmado · replay rechazado',
    },
    description: {
  ...
  },
  {
    ...
    cf: '03',
    terminal: {
      en: 'emberwall — boot · sentinel armed · mqtt tls',
      es: 'emberwall — boot · sentinel armado · mqtt tls',
    },
    description: {
  ...
  },
  {
    ...
    cf: '08',
    terminal: {
      en: 'phosphor — guarding · sha-256 · hmac:on',
      es: 'phosphor — vigilando · sha-256 · hmac:on',
    },
    description: {
  ...
  },
  {
    ...
    cf: '07',
    terminal: {
      en: 'maat — buffer ≠ disk · write blocked',
      es: 'maat — buffer ≠ disco · guardado bloqueado',
    },
    description: {
  ...
  },
  {
    ...
    cf: '02',
    terminal: {
      en: 'crypto-watch — btc/eur · ws:streaming',
      es: 'crypto-watch — btc/eur · ws:streaming',
    },
    description: {
  ...
  },
  {
    ...
    cf: '05',
    terminal: {
      en: 'honeytrap — reply suppressed · factor 4.5',
      es: 'honeytrap — respuesta suprimida · factor 4.5',
    },
    description: {
  ...
  },
  {
    ...
    repo: 'keystone-control-plane',
    started: '2026-09-02',
    updated: '2026-09-06',
    cf: '02',
    terminal: {
      en: 'keystone — cohort 25% · rollback armed',
      es: 'keystone — cohorte 25% · rollback armado',
    },
    description: {
    ...
    url: 'https://github.com/Zoel-Manchon/keystone-control-plane',
  },
  {
    number: '12',
    title: {
    ...
    cf: '01',
    terminal: {
      en: 'ferrogate — cross-tenant query · 0 rows',
      es: 'ferrogate — consulta entre tenants · 0 filas',
    },
    description: {
  ...
  },
  {
    ...
    cf: '12',
    terminal: {
      en: 'psychron — backlog replayed · shape intact',
      es: 'psychron — backlog reinyectado · forma intacta',
    },
    description: {
...
/** Masthead figures, derived from the entries rather than typed by hand. */
export const logbook = {
  opened: projects.reduce((a, p) => (p.started < a ? p.started : a), projects[0]!.started),
  latest: projects.reduce((a, p) => (p.updated > a ? p.updated : a), projects[0]!.updated),
